...
@section('content')
    ...
    <section id="hero" class="hero section">
        ...
        <div class="container d-flex flex-column justify-content-center align-items-center text-center position-relative"
            data-aos="zoom-out">
            <img src="{{ asset('admin/assets/img/logo_abd.jpg') }}" width="500px" class="img-fluid animated" alt="">
            <h1>Welcome to <span>ABD-RO</span></h1>
            <p>Kami, ABD Rental, merupakan perusahaan jasa yang bergerak di bidang sewa tenda, dekorasi, wedding organizer,
    ...
    <section id="about" class="about section">
        ...
        <div class="container" data-aos="fade-up">
            ...
            <div class="row g-4 g-lg-5" data-aos="fade-up" data-aos-delay="200">
                ...
                <div class="col-lg-5">
                    <div class="about-img">
                        <img src="{{ asset('company-profile/assets/img/about-portrait.jpg') }}" class="img-fluid"
                            alt="">
                    </div>
                </div>
                ...
                <div class="col-lg-7">
                    ...
                    <ul class="nav nav-pills mb-3">
                        <li><a class="nav-link active" data-bs-toggle="pill" href="#about-tab1">Saepe fuga</a>
                        </li>
        ...
        <div class="container" data-aos="fade-up">
            ...
            <div class="row gy-4">
                ...
                <div class="col-xl-2 col-md-3 col-6 client-logo">
                    <img src="{{ asset('company-profile/assets/img/clients/client-1.png') }}" class="img-fluid"
                        alt="">
                </div><!-- End Client Item -->
        ...
        <div class="container" data-aos="zoom-out">
            ...
            <div class="row g-5">
                ...
                <div class="col-lg-4 col-md-6 order-first order-md-last d-flex align-items-center">
                    <div class="img">
                        <img src="{{ asset('company-profile/assets/img/cta.jpg') }}" alt="" class="img-fluid">
                    </div>
                </div>
            ...
            <div class="tab-content">
                ...
                <div class="tab-pane fade active show" id="features-tab-1">
                    <div class="row gy-4">
                        ...
                        <div class="col-lg-4 order-1 order-lg-2 text-center" data-aos="fade-up" data-aos-delay="200">
                            <img src="{{ asset('company-profile/assets/img/features-1.svg') }}" alt=""
                                class="img-fluid">
                        </div>
                    </div>
                ...
                <div class="tab-pane fade" id="features-tab-2">
                    <div class="row gy-4">
                        ...
                        <div class="col-lg-4 order-1 order-lg-2 text-center">
                            <img src="{{ asset('company-profile/assets/img/features-2.svg') }}" alt=""
                                class="img-fluid">
                        </div>
                    </div>
                ...
                <div class="tab-pane fade" id="features-tab-3">
                    <div class="row gy-4">
                        ...
                        <div class="col-lg-4 order-1 order-lg-2 text-center">
                            <img src="{{ asset('company-profile/assets/img/features-3.svg') }}" alt=""
                                class="img-fluid">
                        </div>
                    </div>
                ...
                <div class="tab-pane fade" id="features-tab-4">
                    <div class="row gy-4">
                        ...
                        <div class="col-lg-4 order-1 order-lg-2 text-center">
                            <img src="{{ asset('company-profile/assets/img/features-4.svg') }}" alt=""
                                class="img-fluid">
                        </div>
                    </div>
                ...
                <div class="tab-pane fade" id="features-tab-5">
                    <div class="row gy-4">
                        ...
                        <div class="col-lg-4 order-1 order-lg-2 text-center">
                            <img src="{{ asset('company-profile/assets/img/features-5.svg') }}" alt=""
                                class="img-fluid">
                        </div>
                    </div>
                ...
                <div class="tab-pane fade" id="features-tab-6">
                    <div class="row gy-4">
                        ...
                        <div class="col-lg-4 order-1 order-lg-2 text-center">
                            <img src="{{ asset('company-profile/assets/img/features-6.svg') }}" alt=""
                                class="img-fluid">
                        </div>
                    </div>
            ...
            <div class="row gy-5">
                ...
                <div class="col-xl-4 col-md-6" data-aos="zoom-in" data-aos-delay="200">
                    <div class="service-item">
                        <div class="img">
                            <img src="{{ asset('company-profile/assets/img/services-1.jpg') }}" class="img-fluid"
                                alt="">
                        </div>
                ...
                <div class="swiper-wrapper">
                    ...
                    <div class="swiper-slide">
                        <div class="testimonial-item">
                            <img src="{{ asset('company-profile/assets/img/testimonials/testimonials-1.jpg') }}"
        ...
        <div class="container-fluid">
            ...
            <div class="row gy-4">
                ...
                <div class="col-lg-5 order-1 order-lg-2">
                    <img src="{{ asset('company-profile/assets/img/faq.jpg') }}" class="img-fluid" alt=""
                ...
                <div class="row g-0 isotope-container" data-aos="fade-up" data-aos-delay="200">
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6 portfolio-item isotope-item filter-app">
                        <div class="portfolio-content h-100">
                            <img src="{{ asset('company-profile/assets/img/portfolio/app-1.jpg') }}" class="img-fluid"
                                alt="">
                            <div class="portfolio-info">
                                <a href="{{ asset('company-profile/assets/img/portfolio/app-1.jpg') }}"
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6 portfolio-item isotope-item filter-product">
                        <div class="portfolio-content h-100">
                            <img src="{{ asset('company-profile/assets/img/portfolio/product-1.jpg') }}"
                                class="img-fluid" alt="">
                            <div class="portfolio-info">
                                <a href="{{ asset('company-profile/assets/img/portfolio/product-1.jpg') }}"
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6 portfolio-item isotope-item filter-branding">
                        <div class="portfolio-content h-100">
                            <img src="{{ asset('company-profile/assets/img/portfolio/branding-1.jpg') }}"
                                class="img-fluid" alt="">
                            <div class="portfolio-info">
                                <a href="{{ asset('company-profile/assets/img/portfolio/branding-1.jpg') }}"
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6 portfolio-item isotope-item filter-books">
                        <div class="portfolio-content h-100">
                            <img src="{{ asset('company-profile/assets/img/portfolio/books-1.jpg') }}" class="img-fluid"
                                alt="">
                            <div class="portfolio-info">
                                <a href="{{ asset('company-profile/assets/img/portfolio/books-1.jpg') }}"
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6 portfolio-item isotope-item filter-app">
                        <div class="portfolio-content h-100">
                            <img src="{{ asset('company-profile/assets/img/portfolio/app-2.jpg') }}" class="img-fluid"
                                alt="">
                            <div class="portfolio-info">
                                <a href="{{ asset('company-profile/assets/img/portfolio/app-2.jpg') }}"
                                    data-gallery="portfolio-gallery-app" class="glightbox preview-link"><i
                                        class="bi bi-zoom-in"></i></a>
                                <a href="portfolio-details.html" title="More Details" class="details-link"><i
                                        class="bi bi-link-45deg"></i></a>
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6 portfolio-item isotope-item filter-product">
                        <div class="portfolio-content h-100">
                            <img src="{{ asset('company-profile/assets/img/portfolio/product-2.jpg') }}"
                                class="img-fluid" alt="">
                            <div class="portfolio-info">
                                <a href="{{ asset('company-profile/assets/img/portfolio/product-2.jpg') }}"
                                    data-gallery="portfolio-gallery-product" class="glightbox preview-link"><i
                                        class="bi bi-zoom-in"></i></a>
                                <a href="portfolio-details.html" title="More Details" class="details-link"><i
                                        class="bi bi-link-45deg"></i></a>
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6 portfolio-item isotope-item filter-branding">
                        <div class="portfolio-content h-100">
                            <img src="{{ asset('company-profile/assets/img/portfolio/branding-2.jpg') }}"
                                class="img-fluid" alt="">
                            <div class="portfolio-info">
                                <a href="{{ asset('company-profile/assets/img/portfolio/branding-2.jpg') }}"
                                    data-gallery="portfolio-gallery-branding" class="glightbox preview-link"><i
                                        class="bi bi-zoom-in"></i></a>
                                <a href="portfolio-details.html" title="More Details" class="details-link"><i
                                        class="bi bi-link-45deg"></i></a>
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6 portfolio-item isotope-item filter-books">
                        <div class="portfolio-content h-100">
                            <img src="{{ asset('company-profile/assets/img/portfolio/books-2.jpg') }}" class="img-fluid"
                                alt="">
                            <div class="portfolio-info">
                                <a href="{{ asset('company-profile/assets/img/portfolio/books-2.jpg') }}"
                                    data-gallery="portfolio-gallery-book" class="glightbox preview-link"><i
                                        class="bi bi-zoom-in"></i></a>
                                <a href="portfolio-details.html" title="More Details" class="details-link"><i
                                        class="bi bi-link-45deg"></i></a>
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6 portfolio-item isotope-item filter-app">
                        <div class="portfolio-content h-100">
                            <img src="{{ asset('company-profile/assets/img/portfolio/app-3.jpg') }}" class="img-fluid"
                                alt="">
                            <div class="portfolio-info">
                                <a href="{{ asset('company-profile/assets/img/portfolio/app-3.jpg') }}"
                                    data-gallery="portfolio-gallery-app" class="glightbox preview-link"><i
                                        class="bi bi-zoom-in"></i></a>
                                <a href="portfolio-details.html" title="More Details" class="details-link"><i
                                        class="bi bi-link-45deg"></i></a>
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6 portfolio-item isotope-item filter-product">
                        <div class="portfolio-content h-100">
                            <img src="{{ asset('company-profile/assets/img/portfolio/product-3.jpg') }}"
                                class="img-fluid" alt="">
                            <div class="portfolio-info">
                                <a href="{{ asset('company-profile/assets/img/portfolio/product-3.jpg') }}"
                                    data-gallery="portfolio-gallery-product" class="glightbox preview-link"><i
                                        class="bi bi-zoom-in"></i></a>
                                <a href="portfolio-details.html" title="More Details" class="details-link"><i
                                        class="bi bi-link-45deg"></i></a>
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6 portfolio-item isotope-item filter-branding">
                        <div class="portfolio-content h-100">
                            <img src="{{ asset('company-profile/assets/img/portfolio/branding-3.jpg') }}"
                                class="img-fluid" alt="">
                            <div class="portfolio-info">
                                <a href="{{ asset('company-profile/assets/img/portfolio/branding-3.jpg') }}"
                                    data-gallery="portfolio-gallery-branding" class="glightbox preview-link"><i
                                        class="bi bi-zoom-in"></i></a>
                                <a href="portfolio-details.html" title="More Details" class="details-link"><i
                                        class="bi bi-link-45deg"></i></a>
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6 portfolio-item isotope-item filter-books">
                        <div class="portfolio-content h-100">
                            <img src="{{ asset('company-profile/assets/img/portfolio/books-3.jpg') }}" class="img-fluid"
                                alt="">
                            <div class="portfolio-info">
                                <a href="{{ asset('company-profile/assets/img/portfolio/books-3.jpg') }}"
                                    data-gallery="portfolio-gallery-book" class="glightbox preview-link"><i
                                        class="bi bi-zoom-in"></i></a>
                                <a href="portfolio-details.html" title="More Details" class="details-link"><i
                                        class="bi bi-link-45deg"></i></a>
        ...
        <div class="container" data-aos="fade-up" data-aos-delay="100">
            ...
            <div class="row gy-5">
                ...
                <div class="col-xl-4 col-md-6 d-flex" data-aos="zoom-in" data-aos-delay="200">
                    <div class="team-member">
                        <div class="member-img">
                            <img src="{{ asset('company-profile/assets/img/team/team-1.jpg') }}" class="img-fluid"
                                alt="">
                        </div>
                ...
                <div class="col-xl-4 col-md-6 d-flex" data-aos="zoom-in" data-aos-delay="400">
                    <div class="team-member">
                        <div class="member-img">
                            <img src="{{ asset('company-profile/assets/img/team/team-2.jpg') }}" class="img-fluid"
                                alt="">
                        </div>
                        <div class="member-info">
                            <div class="social">
            ...
            <div class="row gy-4">
                ...
                <div class="col-xl-4 col-md-6" data-aos="fade-up" data-aos-delay="100">
                    <article>
                        ...
                        <div class="post-img">
                            <img src="{{ asset('company-profile/assets/img/blog/blog-1.jpg') }}" alt=""
                                class="img-fluid">
                        </div>
                        ...
                        <div class="d-flex align-items-center">
                            <img src="{{ asset('company-profile/assets/img/blog/blog-author.jpg') }}" alt=""
                ...
                <div class="col-xl-4 col-md-6" data-aos="fade-up" data-aos-delay="200">
                    <article>
                        ...
                        <div class="post-img">
                            <img src="{{ asset('company-profile/assets/img/blog/blog-2.jpg') }}" alt=""
                                class="img-fluid">
                        </div>
                        ...
                        <div class="d-flex align-items-center">
                            <img src="{{ asset('company-profile/assets/img/blog/blog-author-2.jpg') }}" alt=""
                                class="img-fluid post-author-img flex-shrink-0">
                            <div class="post-meta">
                ...
                <div class="col-xl-4 col-md-6" data-aos="fade-up" data-aos-delay="300">
                    <article>
                        ...
                        <div class="post-img">
                            <img src="{{ asset('company-profile/assets/img/blog/blog-3.jpg') }}" alt=""
                                class="img-fluid">
                        </div>
                        ...
                        <div class="d-flex align-items-center">
                            <img src="{{ asset('company-profile/assets/img/blog/blog-author-3.jpg') }}" alt=""
                                class="img-fluid post-author-img flex-shrink-0">
                            <div class="post-meta">
