        ...
        deleteButtons.forEach((button) => {
            button.addEventListener('click', function() {
                ...
                Swal.fire({
                    ...
                    text: 'Do you want to delete this service area?',
                    icon: 'warning',
...
<script>
    $(document).on('click', '.serviceAreaUpdate', function() {
        var _this = $(this).parents('tr');

        // Mengisi input dengan data dari tabel
        $('#e_id_updateServiceArea').val(_this.find('.id_updateServiceArea').text());
        ...
        $('#perPageSelect').change(function() {
            ...
            $.ajax({
                ...
                success: function(data) {
                    $('#serviceAreaTableContainer').html($(data).find(
                            '#serviceAreaTableContainer')
                        .html());
                }
            });
        });
