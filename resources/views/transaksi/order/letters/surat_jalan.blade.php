...
<head>
    ...
    <title>SURAT JALAN - ORDER {{ $cetakOrder->order_number }}</title>
            ...
            <div class="row">
                <div>
                    <div>
                        ...
                        @if ($cetakOrder->sender_name)
                            <div class="section-title text-info-jalan">Nama Pengirim :
                                <b>{{ $cetakOrder->sender_name }}</b>
                            </div>
                        @endif
