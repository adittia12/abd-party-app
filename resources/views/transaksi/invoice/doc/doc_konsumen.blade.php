    ...
    <div class="main-content">
        <section class="section">
            ...
            <div class="row">
                <div>
                    <div>
                        <p class="mt-3">Kepada : <b>{{ $cetakonsumen->name_customer }}</b> <br>
                            {{ $cetakonsumen->invoice_address }}
                        </p>
                        <input type="hidden" name="id" value="{{ Crypt::encrypt($cetakonsumen->id_invoice) }}">
                        <div class="section-title mt-0">Order : <b>{{ $cetakonsumen->order_number }}</b></div>
                    ...
                    <table class="table table-striped table-hover mt-2">
                        ...
                        <tfoot class="small">
                            ...
                            @if ($pajak)
                                <tr>
                                    <th colspan="5" class="text-right">Pajak ({{ $cetakonsumen->jenis_pajak }})</th>
            ...
            <div class="row">
                <div class="">
                    <div class="">
                        <table class="table">
                            <tr>
                                <td>{{ $cetakonsumen->name_customer }} <br> {{ $cetakonsumen->invoice_address }}</td>
                                <td></td>
                                <td></td>
                                <td></td>
                                <td></td>
                                ...
                                <td>
                                    ...
                                    <p class="small">
                                        ...
                                        {{ \Carbon\Carbon::parse($cetakonsumen->start_event)->translatedFormat('d F Y') }}
                                        <br>
